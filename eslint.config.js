...
export default [
  // browser-side script served to the editing iframe, not part of the typescript project
  { ignores: ['src/static/**'] },
  // FORMATTING RULES
  {
  ...
  },
  {
    ...
    rules: {
      ...
      '@typescript-eslint/no-unsafe-argument': 'off', // rendering passes any (page data, templating props) pervasively
